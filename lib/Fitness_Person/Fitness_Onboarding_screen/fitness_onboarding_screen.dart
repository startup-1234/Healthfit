...
class FitnessOnboardingScreen extends StatefulWidget {
  const FitnessOnboardingScreen({super.key});
...
class _FitnessOnboardingScreenState extends State<FitnessOnboardingScreen>{
  ...
  void initState() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 5), (Timer timer) {
      if (_activePage < FitnessonbordimgList.length - 1) {
        _activePage++;
      } else {
        _activePage = 0;
      }
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [Colors.black.withOpacity(0.99), Colors.transparent],
                          ),
                        ),
                      ),
                    ),
                ...
                child: InkWell(
                  onTap: (){
                    Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => FitnessSignInScreen(),
                    )
                    );
