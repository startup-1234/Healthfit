...
class FitnessNewpasswordScreen extends StatefulWidget {
  const FitnessNewpasswordScreen({super.key});

  @override
  State<FitnessNewpasswordScreen> createState() => _FitnessNewpasswordScreenState();
}

class _FitnessNewpasswordScreenState extends State<FitnessNewpasswordScreen> {
