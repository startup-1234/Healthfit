...
import 'consult_nutritionist.dart';

class NUtritionistDetails extends StatefulWidget {
  const NUtritionistDetails({super.key});

  @override
  State<NUtritionistDetails> createState() => _NUtritionistDetailsState();
}
        ...
        child:  Stack(
          children: [
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ConsultNutritionist()));
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: AppText(text: "Personal nutrition",
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(top: 5,bottom: 5),
                                      child: AppText(text: "Monitor serving sizes",
                                        size: 1.8*SizeConfigure.textMultiplier!,
                                        color: kTitleColor,
                                        fw: FontWeight.normal,
                                      ),
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(top: 5,bottom: 5),
                                      child: AppText(text: "Nutrient intakes",
                                        size: 1.8*SizeConfigure.textMultiplier!,
                                        color: kTitleColor,
                                        fw: FontWeight.normal,
                                      ),
                            ...
                            children: [
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: AppText(text: "ISSA Nutritionist Certification",
                                    size: 1.8*SizeConfigure.textMultiplier!,
                                    color: kTitleColor,
                                    fw: FontWeight.normal,
                                  ),
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 10,right: 10,top: 5,bottom: 5),
                                  child: AppText(text: "Fitness Mentor Virtual Nutrition\nCoach Certification",
                                    size: 1.8*SizeConfigure.textMultiplier!,
                                    color: kTitleColor,
                                    fw: FontWeight.normal,
                                  ),
                ...
                children: [
                  InkWell(
                    onTap: () {
                      ...
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>NUtritionistDetails()));
                    },
                    child: Container(
                      decoration: BoxDecoration(
