...
import 'nutritionist_details.dart';

class ConsultNutritionist extends StatefulWidget {
  const ConsultNutritionist({super.key});

  @override
  State<ConsultNutritionist> createState() => _ConsultNutritionistState();
}

class _ConsultNutritionistState extends State<ConsultNutritionist> {
  int? passIndex;
                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => NUtritionistDetails(
