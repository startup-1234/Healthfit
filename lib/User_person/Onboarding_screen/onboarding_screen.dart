...
import 'package:heathfit/common_widget/button_global.dart';
import 'package:heathfit/utilities/sizeconfigure.dart';
import '../../Models/model.dart';
import '../../utilities/constant.dart';
import '../Questionnaire_screen/decide_screen.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void initState() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 5), (Timer timer) {
      if (_activePage < onbordimgList.length - 1) {
        _activePage++;
      } else {
        _activePage = 0;
      }
        ...
        children: [
          Expanded(
            child: PageView.builder(
              ...
              itemCount: onbordimgList.length,
                ...
                return Stack(
                  children: [
                    Image.asset(
                      ...
                      height: MediaQuery.of(context).size.height, // Specify a fixed height for the Image
                    ),
                    Container(
